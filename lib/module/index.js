...
export const openSubscriptionManager = params => {
  InteractionManager.runAfterInteractions(() => {
    setTimeout(() => {
...
export const addSubscriptionManagerListener = (eventName, callback) => {
...
export const updateCardSwitcherSessionId = sessionId => {
